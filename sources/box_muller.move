...
friend grndx::prob_distribution;
...
#[lint::allow_unsafe_randomness]
 public fun normal_r1(): FixedPoint64WithSign {
        let u1 = randomness::u128_range(1,10000000000000000);
        let u2 = randomness::u128_range(1,10000000000000000);
