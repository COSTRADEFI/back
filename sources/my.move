...
module grndx::gamepoint {
    ...
    const ASSET_SYMBOL: vector<u8> = b"COSPT";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            constructor_ref,
            option::none(),
            utf8(b"Costrade Point"), /* name */
            utf8(ASSET_SYMBOL), /* symbol */
            0, /* decimals */
            utf8(b"https://f5c4dfa0fe2c14e113d9881788a255fa.blok.host/favicon.ico"), /* icon */
            utf8(b"https://f5c4dfa0fe2c14e113d9881788a255fa.blok.host/favicon.ico"), /* project */
        );
    ...
    public fun get_metadata(): Object<Metadata> {
        let asset_address = object::create_object_address(&@grndx, ASSET_SYMBOL);
